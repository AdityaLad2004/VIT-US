  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-8">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg">
        <h1 className="text-4xl font-bold mb-4 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-blue-500">{project.name}</h1>
        <h2 className="text-2xl font-semibold mb-4 text-center">{project.makerName}</h2>
        <p className="mb-4 text-center">{project.makerEmail}</p>
        ...
        <form onSubmit={handleConfirm} className="space-y-6">
          <label className="block">
            ...
            <input 
              ...
              value={requestInfo.name} 
              onChange={handleChange} 
              className="bg-gray-700 text-white p-3 rounded-lg w-full mt-2 border border-gray-600 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition"
            />
          ...
          <label className="block">
            ...
            <input 
              ...
              className="bg-gray-700 text-white p-3 rounded-lg w-full mt-2 border border-gray-600 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition"
            />
            {formErrors.techStack && <p className="text-red-500 text-sm mt-1">{formErrors.techStack}</p>}
          </label>
          <label className="block">
            Past Projects:
            <textarea 
              ...
              className="bg-gray-700 text-white p-3 rounded-lg w-full mt-2 border border-gray-600 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition"
            ></textarea>
            {formErrors.pastProjects && <p className="text-red-500 text-sm mt-1">{formErrors.pastProjects}</p>}
          </label>
          <label className="block">
            Experience:
            <textarea 
          ...
          <button 
            type="submit" 
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg w-full mt-4 transition duration-300"
          >
            {loading ? 'Sending...' : 'Send Request'}
          </button>
        </form>
